trigger EUMIRInitalToFollowup on CMPL123CME__EU_MIR__c (before update) {
 
   Map<Id,CMPL123CME__EU_MIR__c> eumirupdatemap = new Map<Id,CMPL123CME__EU_MIR__c>();
    ...
    CMPL123CME__D_Investigation_Conclusion_Choice_1__c,CMPL123CME__D_Investigation_Conclusion_Choice_2__c,CMPL123CME__D_Investigation_Conclusion_Choice_3__c,CMPL123CME__D_Investigation_Conclusion_Choice_4__c,CMPL123CME__D_Investigation_Conclusion_Choice_5__c,CMPL123CME__D_Investigation_Conclusion_Choice_6__c,title__c FROM CMPL123CME__EU_MIR__c];    
    ...
    for(CMPL123CME__EU_MIR__c emuir : trigger.new){   
        ...
        {           
         eumirupdatemap.put(emuir.id, emuir);
        }
    }
    system.debug('MSR::eumirupdatemap@@@...'+eumirupdatemap);
    if(!eumirupdatemap.isEmpty()){
