...
trigger CMPL123CME_EU_MIR_123Trigger on CMPL123CME__EU_MIR__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
