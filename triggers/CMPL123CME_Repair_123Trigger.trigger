...
trigger CMPL123CME_Repair_123Trigger on CMPL123CME__Repair__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
