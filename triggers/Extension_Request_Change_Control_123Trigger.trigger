...
trigger Extension_Request_Change_Control_123Trigger on Extension_Request_Change_Control__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
