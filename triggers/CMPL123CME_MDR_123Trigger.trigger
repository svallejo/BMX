...
trigger CMPL123CME_MDR_123Trigger on CMPL123CME__MDR__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
