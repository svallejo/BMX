...
trigger CMPL123CME_MEDDEV_123Trigger on CMPL123CME__MEDDEV__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
