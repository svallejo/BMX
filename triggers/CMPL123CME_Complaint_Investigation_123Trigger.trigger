...
trigger CMPL123CME_Complaint_Investigation_123Trigger on CMPL123CME__Complaint_Investigation__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
