...
trigger CAPA_Effectiveness_Check_123Trigger on CAPA_Effectiveness_Check__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
    ...
    /* Before Update */
        ...
        //User should not be able to submit CAPA EC  for Submit for Review without any tasks
        CAPAEffectivenessHandler.CAPApreventSubmitforReview(Trigger.newMap, Trigger.oldMap);
