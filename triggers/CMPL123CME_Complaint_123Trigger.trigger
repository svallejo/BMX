...
trigger CMPL123CME_Complaint_123Trigger on CMPL123CME__Complaint__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
