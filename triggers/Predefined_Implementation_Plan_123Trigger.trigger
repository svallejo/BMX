...
trigger Predefined_Implementation_Plan_123Trigger on Predefined_Implementation_Plan__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
