...
trigger CMPL123CME_HHE_123Trigger on CMPL123CME__HHE__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
