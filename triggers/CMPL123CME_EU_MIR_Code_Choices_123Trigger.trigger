...
trigger CMPL123CME_EU_MIR_Code_Choices_123Trigger on CMPL123CME__EU_MIR_Code_Choices__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
