...
trigger CMPL123_Linked_Document_Change_Control_123Trigger on CMPL123__Linked_Document_Change_Control__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
